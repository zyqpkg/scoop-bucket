...
| [cursor-cli](bucket/cursor-cli.json) | Cursor CLI - run Cursor agents from the terminal | 2026.07.13-7fe37d2 | [cursor.com](https://cursor.com/cli) | 2026-07-16 |
...
| [kilo](bucket/kilo.json) | Kilo - all-in-one agentic engineering platform. Build, sh... | 7.4.11 | [github.com](https://github.com/Kilo-Org/kilocode) | 2026-07-15 |
...
| [paseo](bucket/paseo.json) | Coding agents from your phone, desktop and CLI (Desktop E... | 0.1.109 | [paseo.sh](https://paseo.sh) | 2026-07-16 |
| [pi](bucket/pi.json) | AI agent toolkit: unified LLM API, agent loop, TUI, codin... | 0.80.9 | [github.com](https://github.com/earendil-works/pi) | 2026-07-16 |
