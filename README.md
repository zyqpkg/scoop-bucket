...
| [mootool](bucket/mootool.json) | Handy developer tool set (Java version, includes bundled ... | 1.8.6 | [github.com](https://github.com/rememberber/MooTool) | 2026-08-10 |
...
| [cli-manager](bucket/cli-manager.json) | CLI-Manager: 用于集中管理基于CLI 的多个开发项目，解决多窗口切换、重复输入命令的痛点，提升开发工作... | 1.3.5 | [github.com](https://github.com/dark-hxx/CLI-Manager) | 2026-08-05 |
