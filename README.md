...
| [clipp](bucket/clipp.json) | Cross-platform peer-to-peer clipboard sync for trusted de... | 1.3.0.133 | [github.com](https://github.com/martona/clipp) | 2026-07-16 |
...
| [codexplusplus](bucket/codexplusplus.json) | Codex App 的外部增强启动器和管理工具，通过 CDP 注入增强功能，不修改 Codex 原始安装文件 | 1.2.39 | [github.com](https://github.com/BigPizzaV3/CodexPlusPlus) | 2026-07-16 |
